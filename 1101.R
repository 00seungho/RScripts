...
apikey = "NiGhn1xzYgu3Jk2dfWcsdseqg0Iufba%2FpRhl0nHbuNsDK8poZ0xTKBgyTNO0mzWieKL4TtLgCY0oTGD15kFlWw%3D%3D"
...
#행렬 데이터를 데이터프레임으로 변환
df.regin = as.data.frame(pm.regin)
df.regin

colnames(df.regin) = "PM10"
